...
RSpec.describe(ActiveInvoicing::Accounting::Quickbooks::TxnTaxDetail) do
  describe "attributes" do
    let(:txn_tax_detail) do
      described_class.new(
        txn_tax_code_ref: ActiveInvoicing::Accounting::Quickbooks::BaseReference.new(value: "TAX", name: "Sales Tax"),
        total_tax: 50.00,
    ...
    it "has txn_tax_code_ref attribute" do
      expect(txn_tax_detail.txn_tax_code_ref).to(be_a(ActiveInvoicing::Accounting::Quickbooks::BaseReference))
  ...
  describe "JSON mapping" do
    ...
    it "serializes to JSON" do
      txn_tax_detail = described_class.new(
        txn_tax_code_ref: ActiveInvoicing::Accounting::Quickbooks::BaseReference.new(value: "GST", name: "Goods and Services Tax"),
        total_tax: 100.00,
