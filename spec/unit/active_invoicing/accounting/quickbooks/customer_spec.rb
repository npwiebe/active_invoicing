...
RSpec.describe(ActiveInvoicing::Accounting::Quickbooks::Customer) do
  let(:connection) do
    instance_double(
  ...
  subject(:customer) { ActiveInvoicing::Accounting::Quickbooks::Response.from_json(customer_data).customer }
