...
RSpec.describe(ActiveInvoicing::Accounting::Quickbooks::Invoice) do
  let(:connection) do
    instance_double(
  ...
  subject(:invoice) { ActiveInvoicing::Accounting::Quickbooks::Response.from_json(invoice_data).invoice }
